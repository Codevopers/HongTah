...
<section class="services p-0 position-relative text-center" style="background:#f8f8f8;">
    <div class="container">
...
<section class="services p-0 position-relative text-center" style="color:#fff;background:#507474;">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6 p-0">
            </div>
